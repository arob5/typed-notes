...
\subsection{Review of Random Walks}
\textbf{TODO}
...
a white noise process in $d$ dimensions. We'd still find $\E B(t) = 0$ (interpreting the integral component-wise) and now $\Var(B(t))$ as the covariance matrix of $B(t)$. 
To find this covariance matrix, first note that by independence $\E W(t$ for $s \neq t$.
...
\item Generalization of a random walkc
\end{enumerate}
