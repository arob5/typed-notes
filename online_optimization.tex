...
In this section we see one of the many applications of the multiplicative weights update algorithm; namely, its use in learning linear classifiers. We consider a typical classification setup
with data
