...
discuss them here. The case where $\tilde{\pi}(x)$ is unimodal is much simpler, since this guarantees that the slice $S_x$ is a connected region (there are no holes or separate pieces). 
