...
\begin{align*}
\Sigma &=  \left[\frac{1}{\gamma^2} G^T \Sigma_{\epsilon}^{-1} G + \Sigma_0^{-1} \right]^{-1}  = \gamma^2 \left[G^T \Sigma_{\epsilon}^{-1} G + \gamma^2 \Sigma_0^{-1} \right]^{-1} \\
\mu &= \left[G^T \Sigma_{\epsilon}^{-1} G + \gamma^2 \Sigma_0^{-1} \right]^{-1}  \left[G^T \Sigma_{\epsilon}^{-1}y + \gamma^2 \Sigma_0^{-1} \mu_0 \right]
\end{align*}
...
To show $\Sigma \to 0$, we prove that the eigenvalues of $\Sigma$ all converge to $0$. To this end, we first show that $\frac{1}{\gamma^2} G^T \Sigma_{\epsilon}^{-1} G + \Sigma_0^{-1}$
is positive definite. Since $\Sigma_0^{-1}$ is positive definite and $\gamma > 0$, it suffices to show that $G^T \Sigma_{\epsilon}^{-1} G$ is positive definite. To this end let $\theta \neq 0$
and consider 
\[\langle G^T \Sigma_{\epsilon}^{-1}G \theta, \theta \rangle = \langle \Sigma_{\epsilon}^{-1/2}G \theta, \Sigma_{\epsilon}^{-1/2}G \theta \rangle = \norm{\Sigma_{\epsilon}^{-1/2}G \theta}_2^2 > 0 \]
...
$\Sigma_{\epsilon}^{-1/2}\left(G\theta \right) \neq 0$. This verifies that $\frac{1}{\gamma^2} G^T \Sigma_{\epsilon}^{-1} G + \Sigma_0^{-1}$ is positive definite and hence has positive 
eigenvalues. Note that the eigenvalues converge to $+\infty$ as $\gamma \to 0^+$. Thus, the eigenvalues of $\Sigma = \left[\frac{1}{\gamma^2} G^T \Sigma_{\epsilon}^{-1} G + \Sigma_0^{-1}\right]^{-1}$
converge to $0$ as $\gamma \to 0^+$. This verifies $\Sigma \to 0$. 

For the convergence of the mean, consider 
\begin{align*}
\mu &= \Sigma \left[\frac{1}{\gamma^2} G^T \Sigma_{\epsilon}^{-1} y + \Sigma_0^{-1} \mu_0 \right] \\
       &= \frac{1}{\gamma^2} \Sigma G^T \Sigma_{\epsilon}^{-1}y + \Sigma \Sigma_0^{-1} \mu_0 \\
       &= \left[G^T \Sigma_{\epsilon}^{-1} G + \gamma^2 \Sigma_0^{-1}\right]^{-1} G^T \Sigma_{\epsilon}^{-1} y + \Sigma \Sigma_0^{-1} \mu_0 
\end{align*}
As $\gamma \to 0^+$ we see that the second term will vanish since $\Sigma \to 0$. Moreover, $\gamma^2 \Sigma_0^{-1} \to 0$. Therefore, 
\[\lim_{\gamma \to 0^+} \mu = \left(G^T \Sigma_{\epsilon}^{-1} G \right)^{-1} G^T \Sigma_{\epsilon}^{-1} y\]
...
\[\left(G^T \Sigma_{\epsilon}^{-1} G \right)^{-1} G^T \Sigma_{\epsilon}^{-1} y = G^{-1} \Sigma_{\epsilon} \left(G^{T}\right)^{-1} G^T \Sigma_{\epsilon}^{-1} y = G^{-1}y\]
