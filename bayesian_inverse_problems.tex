...
\end{align*}
However, it is actually a bit cleaner to optimize for the \text{direction} $\theta - \theta_t$ rather than $\theta$ itself. Letting $v := \theta - \theta_t$ denote the direction, then we seek to solve
\begin{align}
