...
\newcommand{\predictMat}{\tilde{\mathbf{X}}}
\newcommand{\fObs}[1][]{\mathbf{\f}_{#1}} % Vector of observed target function evaluations.  
\newcommand{\yObs}[1][]{\mathbf{y}_{#1}} % Vector of (potentially noisy) observations. 
\newcommand{\nugget}{\tau}
...
\newcommand{\kerMatApprox}{\hat{\mathbf{K}}} % Approximation to the kernel matrix.
\newcommand{\kerBasisMat}{\boldsymbol{\Phi}} % Basis matrix, outer product of this matrix produces kernel matrix approximation. 
\newcommand{\designMatInducing}{\mathbf{U}} % Matrix of inducing points/pseudoinputs. 
\newcommand{\kerMatInducing}{\mathbf{K}_{\NpseudoData}}
\newcommand{\crossCovInducing}{\mathbf{K}_{\Ndesign \NpseudoData}}
