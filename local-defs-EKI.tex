...
\newcommand{\dimData}{N}
\newcommand{\noise}{\epsilon} % Observation noise random variable 
\newcommand{\covObsNoise}{\Sigma_{\noise}} % Covariance matrix of observation noise. 
...
\newcommand{\priorMeas}{\mu_0} % Prior measure
\newcommand{\postDens}{\pi} % Posterior density
\newcommand{\postMeas}{\mu} % Posterior measure
...
% Ensemble Kalman Inversion and Sampling
\newcommand{\dpar}[1][\timeStep]{\indexTimeStep[#1]{\spar}} % Parameter vector indexed by discrete time. 
\newcommand{\exState}{z} % Extended state
\newcommand{\dexState}[1][\timeStep]{\indexTimeStep[#1]{\exState}}
